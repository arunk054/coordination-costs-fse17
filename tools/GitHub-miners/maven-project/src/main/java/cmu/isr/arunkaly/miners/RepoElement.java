...
public class RepoElement {
	...
	public void setURL() {
		this.url = "https://"+GITHUB_DOMAIN+owner+"/"+repo;
	}
	public RepoElement(String owner, String repo){
		this.owner = owner;
		this.repo = repo;
		setURL();
	}
	...
	private void setOwnerRepo(String repoURL) throws InvalidRepoURLException {
		...
		int domainStrLen = GITHUB_DOMAIN.length();
		int i = repoURL.indexOf(GITHUB_DOMAIN);
		if (i==-1)
